...
def run_simulation(
    ...
    x  = np.zeros((12, n))
    dx = np.zeros((12, n))
    Va = 14.98 #Manobra, m/s, valor definido por cargas (?)
    Vc = 16.3 #Cruzeiro, m/s, valor definido por cargas (?)
    Vd = 22.64 #Mergulho, m/s, valor definido por cargas (?)
    V = Va
    ...
    if V == Va:
        ...
        ail_deflect = 18.38036809815951
    elif V == Vd:
        ail_deflect = 4.4110718492343945

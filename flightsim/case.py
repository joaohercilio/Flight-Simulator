...
class SimCase:
    ...
    fg_port: int = spec("flightgear", 5502, "UDP port (sim → FlightGear)", key="port", max=65535)
    fg_packet_hz: int = spec("flightgear", 60, "Send rate", "Hz", key="packet_hz", min=1, max=1000)
    ...
    js_aileron: int = spec("joystick", 0, "Roll axis", key="aileron_axis", max=32)
    js_elevator: int = spec("joystick", 1, "Pitch axis", key="elevator_axis", max=32)
    js_rudder: int = spec("joystick", 3, "Yaw axis", key="rudder_axis", max=32)
    ...
    js_invert_aileron: bool = spec("joystick", False, "Invert roll (right = +1 expected)", key="invert_aileron")
    js_invert_elevator: bool = spec("joystick", True, "Invert pitch (pull = nose up expected)", key="invert_elevator")
    js_invert_rudder: bool = spec("joystick", False, "Invert yaw (right = +1 expected)", key="invert_rudder")
